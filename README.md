...
任意のフォルダ（例: C:\Users\YourName\Documents\ZMK_Overlay）に本ツールのフォルダを置きます。

layer_viewer.exe を右クリックし、**「ショートカットの作成」**を選択します。

Win + R キーを押し、入力欄に shell:startup と入力して実行します。

開いたスタートアップフォルダの中に、作成したショートカットを移動します。
